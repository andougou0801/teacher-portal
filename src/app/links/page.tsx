...
import { officialLinks, officialLinksNote } from "@/lib/officialLinks";
...
export default function LinksPage() {
  return (
    <section className="mx-auto max-w-3xl px-8 py-14">
      ...
      <div className="flex flex-col gap-4">
        {officialLinks.map((link) => (
          ...
          >
            ...
            <p className="mt-2 text-xs text-muted">{link.description}</p>
      ...
      <p className="mt-8 text-center text-xs text-muted">{officialLinksNote}</p>
    </section>
  );
}

...
export const tools: Tool[] = [
  ...
  },
  {
    ...
    name: "通知表所見文例集",
    description:
      "観点別に217の文例から選んで所見を組み立てられます。文字数カウンター（学校指定の字数に合わせて設定可）、他の児童に使った文例の重複チェック、「他の子との比較」「断定的な否定」などを見つける表現チェック、課題を配慮して伝える言い回しや学期末の結びの文例まで対応。クラス名簿を登録すれば全員分を続けて作成し、まとめてコピー・CSV保存できます。",
    icon: "📝",
    tags: ["学級経営", "校務効率化", "無料"],
    audience: "teacher",
    status: "live",

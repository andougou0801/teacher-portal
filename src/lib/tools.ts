...
export const tools: Tool[] = [
  ...
  },
  {
    ...
    name: "角度マスター",
    description:
      "三角形・四角形の角度の問題を、図を見ながら繰り返し練習できます。分度器を使わずに角の大きさを当てる「見当をつける」、画面の分度器をドラッグして角に置く「分度器のおき方」、分度器の読み取り、一直線と1回転の角、三角じょうぎの角（4年）、三角形・二等辺三角形・四角形・平行四辺形・多角形の角（5年）、三角形の角の応用・三角形の外角（発展）の12単元に対応。応用では、大きい三角形の中に小さい三角形が入った図や、三角形の中の点と頂点を結んだ図で、2〜3段階に分けて考える問題が出ます。まちがえたときは「きみの答え」の角を図に重ねて見せるので、どれくらいちがうのかが目で分かります。おき方の問題は ピッタリ／せいかい／おしい の4段階で判定し、ずれの向きと大きさを教えてその場で直せます。図は毎回自動で作られ、向きも変わるので同じ問題が続きません。学年やにがてな単元での出題、まちがえた問題だけの復習、単元別の正答率の記録にも対応しています。",
    icon: "📐",
    tags: ["算数", "無料"],
    audience: "student",
    status: "live",

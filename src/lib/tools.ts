...
export const tools: Tool[] = [
  ...
  },
  {
    ...
    name: "角度マスター",
    description:
      "三角形・四角形の角度の問題を、図を見ながら繰り返し練習できます。画面の分度器をドラッグして角に置く「分度器のおき方」、分度器の読み取り、一直線と1回転の角、三角じょうぎの角（4年）、三角形・二等辺三角形・四角形・平行四辺形・多角形の角（5年）、三角形の外角（発展）の10単元に対応。おき方の問題では、中心が頂点からずれている・0のめもりの線が辺に重なっていないなど、どこが違うかを指摘し、お手本の置き方を重ねて見せます。図は毎回自動で作られるので同じ問題が続きません。学年やにがてな単元での出題、まちがえた問題だけの復習、単元別の正答率の記録にも対応しています。",
    icon: "📐",
    tags: ["算数", "無料"],
    audience: "student",
    status: "live",
